...
<a href="https://www.akt.org.uk/">www.akt.org.uk/</p>
  `;
};
...
const userEmailTemplate = appt => {
  ...
  <p> If you need to cancel your appointment, please let us know by going to your profile and clicking the cancel button.</p>
  <p> At the time of your appointment, click on this link: https://tlk.io/${
    appt.chatString
  ...
  <p>If you have any questions, concerns or need any additional help, you can contact The Albert Kennedy Trust directly by emailing <a href="mailto:onlinesupport@akt.org.uk"></a></p>
  <p>Best wishes,</p>
  <p>The Albert Kennedy Trust</p>
  <a href="https://www.akt.org.uk/"></a>
  `;
};
