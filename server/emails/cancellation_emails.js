...
const mentorEmailTemplate = appt => {
  ...
  <p>${
    appt.userName
  } has cancelled their appointment with you, which was scheduled for ${newDate}.</p>
...
const userEmailTemplate = appt => {
  ...
  <p>Thank you for letting us know you can no longer make your online mentoring appointment. Your appointment with ${
    appt.mentorName
  } on ${newDate} has now been cancelled.</p>
